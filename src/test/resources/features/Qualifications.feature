Feature: Qualifications
    ...
    I want to set qualifications and observations
    ...
    Scenario: Qualify an applicant
        ...
        When I set a new qualification mark "9" and an observation "excelent work"
        Then The response code is 201
        And I can check that the mark "9" is correct
    ...
    Scenario: Qualify an applicant without being logged as secretary
        ...
        And I can not check that the mark "9" is correct
